...
if ((Get-VM -Name $Win2k19vmName -ErrorAction SilentlyContinue).State -ne "Running") {
    ...
    New-VM -Name $Win2k19vmName -MemoryStartupBytes 4GB -BootDevice VHD -VHDPath $win2k19vmvhdPath -Path $Env:ArcBoxVMDir -Generation 2 -Switch $switchName
...
if ((Get-VM -Name $SQLvmName -ErrorAction SilentlyContinue).State -ne "Running") {
    ...
    New-VM -Name $SQLvmName -MemoryStartupBytes 4GB -BootDevice VHD -VHDPath $SQLvmvhdPath -Path $Env:ArcBoxVMDir -Generation 2 -Switch $switchName
